...
<retina0>
  ...
  <h_mesh>
      ...
      w_l    1.0     # M-cone input weight to H1 mesh
      w_m    1.0     # L-cone input weight to H1 mesh
  </h_mesh>
  ...
  <h_mesh>
      ...
      gp     0.064   # Time from 1 to 1/e, if 'gh' is 0.0
      dt     0.02    # Time increment (time units); Must be <= 1.0
      w_s    1.0     # S-cone input weight to H2 mesh
      w_l    0.1     # M-cone input weight to H2 mesh
      w_m    0.1     # L-cone input weight to H2 mesh
  </h_mesh>
...
#   ad1_init_s    0.35
  ...
  #
  mesh_dump_type    null       # 'val_v_dist', 'mosaic_coord'
